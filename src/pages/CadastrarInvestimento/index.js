import { Menu, Form, Button, message, DatePicker, Layout, Input, InputNumber } from "antd";
...
export default function CadastrarInvestimento(){
    ...
    const onFinishFailed = (erroInfc) => {
        message.danger("Erro ao salvar investimento")
    ...
    return(
        <div className="container">
            <Layout className="layout">
                ...
                <Footer style={{ textAlign: 'center' }}>My Invest c2021</Footer>
            </Layout>
        </div>
    );
}